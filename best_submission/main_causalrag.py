...
def main():
    ...
    zip_path = create_submission(test_probs, test_ids, ckpt['threshold'], config.OUTPUT_DIR, 'exp32_32b_submission_extended_lora')
...
if __name__ == '__main__':
  ...
  Installing bitsandbytes...
   ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ 59.1/59.1 MB 28.0 MB/s eta 0:00:00
2026-01-13 02:25:14.392818: E external/local_xla/xla/stream_executor/cuda/cuda_fft.cc:467] Unable to register cuFFT factory: Attempting to register factory for plugin cuFFT when one has already been registered
WARNING: All log messages before absl::InitializeLog() is called are written to STDERR
E0000 00:00:1768271114.785676      44 cuda_dnn.cc:8579] Unable to register cuDNN factory: Attempting to register factory for plugin cuDNN when one has already been registered
E0000 00:00:1768271114.915893      44 cuda_blas.cc:1407] Unable to register cuBLAS factory: Attempting to register factory for plugin cuBLAS when one has already been registered
W0000 00:00:1768271115.799728      44 computation_placer.cc:177] computation placer already registered. Please check linkage and avoid linking the same target more than once.
W0000 00:00:1768271115.799761      44 computation_placer.cc:177] computation placer already registered. Please check linkage and avoid linking the same target more than once.
W0000 00:00:1768271115.799763      44 computation_placer.cc:177] computation placer already registered. Please check linkage and avoid linking the same target more than once.
W0000 00:00:1768271115.799764      44 computation_placer.cc:177] computation placer already registered. Please check linkage and avoid linking the same target more than once.
  Installing sentence-transformers...
  Installing rank_bm25...
======================================================================
Exp32 32B: CausalRAG + Qwen2.5-32B QLoRA
======================================================================
...
[1/6] Loading data...
  Train:1819 Dev:400 Test:612

[2/6] Initializing Causal Retriever...
  Loading embedding model...
[3/6] Creating 32B model with QLoRA...
  Loading Qwen/Qwen2.5-32B-Instruct with 4-bit quantization...
  ⚠️ This requires ~70GB VRAM - H100 80GB recommended!
...
[5/6] Training CausalRAG 32B...
  ⚠️ This will take ~6-8 hours on H100 80GB!
`use_cache=True` is incompatible with gradient checkpointing. Setting `use_cache=False`.
  Epoch 1: Loss=0.4441, Dev=0.8888 (th=0.725)
  -> New best! 🎉
  Epoch 2: Loss=0.0929, Dev=0.9363 (th=0.650)
  -> New best! 🎉

  Best Dev Score: 0.9363

[6/6] Predicting on TEST...
======================================================================
🏆 CausalRAG 32B Complete!
  Model: Qwen/Qwen2.5-32B-Instruct
  LoRA Rank: 32
  Best Dev: 0.9363
  Baseline exp22_7b: 0.86 | Change: +0.0763
  Submission: /kaggle/working/exp32_32b_output/exp32_32b_submission_extended_lora.zip
======================================================================